...
public class Batch {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // calculating the time before executing the statements
            ...
            for (int i = 0; i < batchSize; i++) {
                ...
                // setting the randomly generated numbers into the statement for execution
                ps.setDouble(1, num1);
                ps.setDouble(2, num2);
                ps.setDouble(3, num3);
                ps.addBatch();
        ...
        System.out.println("All the insertions are done...Goodbye!");
    } // end main
} // end JDBCExample
